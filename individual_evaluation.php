        ...
        <main class="main-content">
            ...
            <div class="overview-cards">
                <div class="overview-card">
                    <?php if ($bestSkill): ?>
                        <p><strong>Best Skill:</strong> <?php echo htmlspecialchars($bestSkill['CriteriaName']); ?></p>
                        <small>Score: <?php echo htmlspecialchars($bestSkill['Score']); ?></small>
                    <?php endif; ?>
                </div>
                <div class="overview-card">
                    <?php if ($needsImprovementSkill): ?>
                        <p><strong>Needs Improvement:</strong> <?php echo htmlspecialchars($needsImprovementSkill['CriteriaName']); ?></p>
                        <small>Score: <?php echo htmlspecialchars($needsImprovementSkill['Score']); ?></small>
                    <?php endif; ?>
                </div>
                <div class="overview-card">
